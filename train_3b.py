...
SAVE_EVERY_SEC = 900
KEEP = 2
DS_CFG = os.environ.get("DS_CFG", "ds_config_3b.json")
...
print(f"3B FP32 | tokens={train_size:,} | tokens/step={tps:,} | block={BLOCK_SIZE}")
...
print("khoi tao 3B duoi ZeRO-3")
with deepspeed.zero.Init(config_dict_or_path=DS_CFG, enabled=True):
    model = GPT(cfg)
print("model 3B-class (khong phai Llama)")
