...
7. **Data, training, and evaluation**: Dataset manifests capture version/source/split metadata. Training plans support future SFT, preference optimization, and RFT runs. Benchmarks use a common evaluator and distinct capability suites.
...
- Supply a concrete trainer behind `TrainingPlan`; this foundation only validates and records training requests.
